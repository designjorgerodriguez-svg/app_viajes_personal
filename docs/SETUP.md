...
Cada día de la tarjeta resuelve mediante la geocodificación pública de Open-Meteo el identificador geográfico más cercano a las coordenadas y abre directamente su previsión semanal en Meteoblue, sin pasar por una lista de ubicaciones. La web pública de Meteoblue trabaja con puntos geográficos con nombre; la consulta para un punto GPS arbitrario requiere su API con clave. Los datos resumidos de la tarjeta proceden de Open-Meteo.
